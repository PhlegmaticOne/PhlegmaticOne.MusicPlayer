...
public class TracksViewModel : PlayerTrackableViewModel
{
    ...
    public TracksViewModel(IPlayerService playerService, MusicNavigation<TrackBaseViewModel, AlbumViewModel> collectionNavigation,
    ...
    public MusicNavigation<TrackBaseViewModel, AlbumViewModel> CollectionNavigation { get; }
