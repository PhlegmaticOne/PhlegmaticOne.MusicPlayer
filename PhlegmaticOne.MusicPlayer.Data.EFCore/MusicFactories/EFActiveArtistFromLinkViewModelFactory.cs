...
public class EFActiveArtistFromLinkViewModelFactory : NavigationFactoryBase<ArtistLinkViewModel, ActiveArtistViewModel>
{
    ...
    public EFActiveArtistFromLinkViewModelFactory(ApplicationDbContext dbContext, IHandMapperService handMapperService, IEntityActionsProvider<TrackBaseViewModel> trackActionsProvider)
    {
