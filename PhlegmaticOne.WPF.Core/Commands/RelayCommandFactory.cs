...
public static class RelayCommandFactory
{
    ...
    public static IRelayCommand CreateCommand<T>(Action<T?> action, Predicate<object?> predicate) where T : class => 
        new RelayGenericCommand<T>(action, predicate);
    public static IRelayCommand CreateRequiredParameterCommand<T>(Action<T> action, Predicate<object?> predicate) where T : class =>
    ...
    public static IRelayCommand CreateAsyncCommand<T>(Func<T?, Task> action, Predicate<object?> predicate,
        Action<Exception>? onException = null) where T : class =>
